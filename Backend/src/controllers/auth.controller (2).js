...
async function registerUserController(req, res) {
  ...
  try {
    ...
    if (error?.code === 11000) return res.status(409).json({ message: "Account already exists with this email address or username" })
...
async function loginUserController(req, res) {
  ...
  try {
    ...
    return res.status(500).json({ message: "Login service is temporarily unavailable. Please try again." })
  }
}
